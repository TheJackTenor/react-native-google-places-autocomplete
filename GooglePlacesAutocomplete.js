...
export default class GooglePlacesAutocomplete extends Component {
  ...
  _onPress = rowData => {
    if (
      ...
      this.props.onlyName
        ? this.props.getText(rowData.structured_formatting.main_text)
        : this.props.getText(this._renderDescription(rowData))
      this._abortRequests()
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {!this.props.disableSugestion && this._getFlatList()}
        {this.props.children}
      </View>
    )
  }
...
GooglePlacesAutocomplete.propTypes = {
  ...
  disableSugestion: PropTypes.bool,
}
